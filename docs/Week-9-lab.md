...
## -18.234  -8.057   0.134   8.033  19.502 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   1.8947     3.6267   0.522    0.605    
## X            -2.2593     0.2043 -11.059 9.97e-12 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 9.685 on 28 degrees of freedom
## Multiple R-squared:  0.8137,	Adjusted R-squared:  0.8071 
## F-statistic: 122.3 on 1 and 28 DF,  p-value: 9.968e-12
```
...
## t1* 6.3002197  0.281718068   4.6040375
## t2* 0.6615263 -0.006830607   0.0753505
```
