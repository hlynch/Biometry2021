...
## -20.645  -6.160   1.086   5.861  17.874 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   0.3036     3.7733    0.08    0.936    
## X            -2.2187     0.2125  -10.44  3.7e-11 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 10.08 on 28 degrees of freedom
## Multiple R-squared:  0.7956,	Adjusted R-squared:  0.7883 
## F-statistic:   109 on 1 and 28 DF,  p-value: 3.698e-11
```
...
## t1* 6.3002197  0.410315779  4.69276974
## t2* 0.6615263 -0.007759423  0.07497883
```
