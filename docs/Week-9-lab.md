...
## -14.368  -5.888  -1.344   7.448  16.970 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   -0.255      3.337  -0.076     0.94    
## X             -2.263      0.188 -12.040 1.38e-12 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 8.911 on 28 degrees of freedom
## Multiple R-squared:  0.8381,	Adjusted R-squared:  0.8323 
## F-statistic:   145 on 1 and 28 DF,  p-value: 1.378e-12
```
...
## t1* 6.3002197  0.306898556  4.65954595
## t2* 0.6615263 -0.005402748  0.07558331
```
