...
## -17.815  -7.224   1.864   6.542  17.242 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   4.3829     3.6068   1.215    0.234    
## X            -2.4210     0.2032 -11.916 1.76e-12 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 9.632 on 28 degrees of freedom
## Multiple R-squared:  0.8353,	Adjusted R-squared:  0.8294 
## F-statistic:   142 on 1 and 28 DF,  p-value: 1.757e-12
```
...
## t1* 6.3002197  0.304679659  4.48806027
## t2* 0.6615263 -0.005773196  0.07300368
```
