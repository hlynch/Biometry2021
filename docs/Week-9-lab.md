...
## -14.917  -6.920  -1.123   6.603  14.183 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   1.1681     3.3868   0.345    0.733    
## X            -2.3454     0.1908 -12.294  8.4e-13 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 9.044 on 28 degrees of freedom
## Multiple R-squared:  0.8437,	Adjusted R-squared:  0.8381 
## F-statistic: 151.1 on 1 and 28 DF,  p-value: 8.397e-13
```
...
## t1* 6.3002197  0.515661469  4.53490260
## t2* 0.6615263 -0.009198087  0.07340361
```
