...
## -15.8988  -6.3365   0.9503   5.1240  19.1922 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  -1.0702     3.4019  -0.315    0.755    
## X            -2.2146     0.1916 -11.557  3.6e-12 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 9.085 on 28 degrees of freedom
## Multiple R-squared:  0.8267,	Adjusted R-squared:  0.8205 
## F-statistic: 133.6 on 1 and 28 DF,  p-value: 3.6e-12
```
...
## t1* 6.3002197  0.306895255  4.72874590
## t2* 0.6615263 -0.007733257  0.07723763
```
