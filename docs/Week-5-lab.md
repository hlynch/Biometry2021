...
## t = 1.9116, df = 195.29, p-value = 0.0574
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.01575984  1.00963377
## sample estimates:
## mean of x mean of y 
##  1.329922  0.832985
```
...
## 
## data:  sample.a and sample.b
## t = 1.9116, df = 195.29, p-value = 0.0287
...
## 
## data:  sample.a and sample.b
## t = 1.9116, df = 195.29, p-value = 0.9713
...
## 
## data:  sample.a and sample.b
## t = -1.6001, df = 99, p-value = 0.1128
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.45045719  0.04828061
## sample estimates:
...
## 
## data:  sample.a and sample.b
## t = -0.83936, df = 197.97, p-value = 0.4023
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.6735328  0.2713562
## sample estimates:
...
## 
## data:  sample.a and sample.b
## F = 1.8276, num df = 99, denom df = 99, p-value = 0.002977
