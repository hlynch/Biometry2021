...
medley <- read.csv("~/Dropbox/Biometry/Week 11 Single factor ANOVA/Week 11 Lab/medley.csv", header = TRUE)
...
quinn <- read.csv("~/Dropbox/Biometry/Week 11 Single factor ANOVA/Week 11 Lab/quinn.csv", header = TRUE)
...
```{r echo=FALSE, fig.align='center', fig.cap='Nested ANOVA with no sub-sampling', out.width='60%'}
knitr::include_graphics('NestedANOVA_NoSubsampling.png')
```
